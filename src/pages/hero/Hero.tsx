  ...
  return (
    <section className='md:px-4'>
      ...
      <div className='flex gap-2 justify-center sm:self-start mt-8'>
        <button className='p-2 sm:flex-auto sm:p-2.5 sm:text-sm rounded-full bg-accent font-light flex-1 lg:text-lg text-main mt-4'>Download CV</button>
        <button className='p-2 sm:flex-auto sm:p-2.5 sm:text-sm rounded-full bg-accent font-light flex-1 lg:text-lg text-main mt-4'>Contact Me</button>
      </div>
      </div>
    </section>
  )
