...
export default function Hero() {
  ...
  return (
    <section className='p-6 pt-20 flex flex-col '>
      ...
      <h2 className='text-2xl font-light'>I am a <span className='text-accent font-bold'>Frontend Developer</span></h2>
      ...
      <div className='flex gap-2 justify-center'>
        <button className='p-2 rounded-full bg-accent font-light flex-1 text-lg text-main mt-6'>Download CV</button>
        <button className='p-2 rounded-full bg-accent font-light flex-1 text-lg text-main mt-6'>Contact Me</button>
      </div>
    </section>
  )
}
